...
const Card: React.FC = () => {
  ...
  return (
    <div
      className="relative mx-auto border-gray-00 dark:border-gray-600 bg-gray-800 border-[14px] rounded-[2.5rem] h-[900px] w-[500px] shadow-xl"
      ref={cardRef}
    >
      ...
      <div className="rounded-[2rem] overflow-hidden w-[472px] h-[872px] bg-gray-50 dark:bg-gray-800">
        <img
          src="https://e0.pxfuel.com/wallpapers/817/898/desktop-wallpaper-general-portrait-display-earth-space-earth-illustration-earth-space-cool-portrait.jpg"
          className="dark:hidden w-[472px] h-[872px]"
          alt=""
        />
        <img
          src="https://e0.pxfuel.com/wallpapers/817/898/desktop-wallpaper-general-portrait-display-earth-space-earth-illustration-earth-space-cool-portrait.jpg"
          className="hidden dark:block w-[472px] h-[872px]"
          alt=""
        />
      </div>
    </div>
